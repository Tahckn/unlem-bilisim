<template>
    <section
        class="px-[30px] pb-[42px] pt-[30px] gap-y-[20px] flex flex-col w-full h-auto shadow-sm border border-[#F1F1F2] rounded-xl">
        <!-- header  -->
        <div class="flex items-center">
            <div class="flex gap-x-[5px] items-center justify-center">
                <h2 class="text-[#181C32] text-[14px] leading-[12px]  md:text-[18px] font-semibold md:leading-[16px]">Oturumlar</h2>
        ...
        <div class="overflow-x-auto w-full">
            ...
            <div
                ...
                <div class="min-w-[122px]">
                    <p
                        class="text-danger font-semibold leading-[12px] h-[32px] w-[26px]  flex justify-center items-center rounded-[4px] bg-[#FFF5F8] text-[12px]">
                        ERR</p>
                </div>
                <p class="text-[#7E8299] min-w-[122px] font-semibold leading-[12px] text-[12px]">Authentication</p>
                <p class="text-[#7E8299] min-w-[122px] font-semibold leading-[14px] text-[14px]">236.125.56.78</p>
