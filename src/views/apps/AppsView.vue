        ...
        <div class="flex flex-col w-full">
            ...
            <div class="flex">
                <main
                    ...
                    <div>
                        <div
                            class="flex flex-col md:flex-row gap-y-[12px] justify-between px-[20px] pt-[20px] items-center">
                            <input class="bg-[#F9F9F9] w-full min-w-[165px] md:w-auto lg:w-[279px] px-[12px] h-[38px]"
                                type="text" placeholder="Ara" name="search" id="search">
                            <div
...
import AppsAvatarCard from '@/components/AppsAvatarCard.vue';
</script>
